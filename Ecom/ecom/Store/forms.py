...
from django.contrib.auth.forms import UserCreationForm , UserChangeForm ,SetPasswordForm# for register, update user using django
...
#profile create form github jhon elder 
